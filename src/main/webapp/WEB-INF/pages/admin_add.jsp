...
<div class="templatemo-content col-1 light-gray-bg">
  ...
  <div class="templatemo-content-container">
    <div class="templatemo-content-widget white-bg">
      ...
      <form:form action="${pageContext.request.contextPath}/admin_save" class="templatemo-login-form"
                 method="POST" enctype="multipart/form-data" modelAttribute="admin"
        ...
        <div class="row form-group">
          <div class="col-lg-6 col-md-6 form-group">
            ...
            <form:input class="form-control" id="name"  path="username" placeholder="必填"/>
          </div>
        </div>
